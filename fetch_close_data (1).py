...
This version auto-finds the Excel file in the SAME folder as this script
(no absolute path editing needed) - matches fetch_nse_all_stocks.py's behaviour,
so both scripts always use the same workbook.
"""
import sys
